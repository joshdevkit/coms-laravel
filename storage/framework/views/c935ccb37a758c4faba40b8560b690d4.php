            ...
            <div class="col-md-6">
                <div class="card border-2">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('member.update-password')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\construction-management-system\resources\views/member/password/update-password.blade.php ENDPATH**/ ?>