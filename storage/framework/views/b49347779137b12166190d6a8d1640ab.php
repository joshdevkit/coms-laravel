...
<head>
  ...
  <title>Member | <?php echo e(config('app.name')); ?></title>
...
<div class="wrapper">
    <?php echo $__env->make('templates.member.topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('templates.member.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="content-wrapper">
         <?php echo $__env->yieldContent('content'); ?>

    <?php echo $__env->make('templates.member.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH C:\xampp\htdocs\construction-management-system\resources\views/templates/member/header.blade.php ENDPATH**/ ?>