        ...
        <div class="row justify-content-center align-items-center py-5">
            <div class="col-md-5">
                <div class="card">
                    ...
                    <?php endif; ?>
                        <form id="change_password" class="<?php if(!session('isOTP')): ?> d-block <?php else: ?> d-none <?php endif; ?>" action="<?php echo e(route('member.change-password')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <form id="otp_password" class="<?php if(session('isOTP')): ?> d-block <?php else: ?> d-none <?php endif; ?>" action="<?php echo e(route('member.change-password-otp')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="form-group mb-3">
...
<?php echo $__env->make('templates.member.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\construction-management-system\resources\views/member/password/change-password.blade.php ENDPATH**/ ?>