...
<?php echo $__env->make(Auth::user()->type === 1 ? 'templates.admin.header' : (Auth::user()->type === 2 ? 'templates.manager.header' : (Auth::user()->type === 3 ? 'templates.member.header' : (Auth::user()->type === 0 ? 'templates.owner.header' : 'templates.default.header'))), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\construction-management-system\resources\views/profile/account-settings.blade.php ENDPATH**/ ?>