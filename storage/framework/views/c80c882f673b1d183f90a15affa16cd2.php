        ...
        <div class="row mt-3 py-3">
            <div class="col-m-d-8 col-lg-8 col-sm-12">
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table m-0 table-hover table-sm">
                            <colgroup>
                                <col width="5%">
                                <col width="30%">
                                <col width="35%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/projects/view-details/<?php echo e($row->id); ?>"
                                                class="btn btn-sm btn-primary"><i class="fas fa-folder"></i> View</a>
                                        </td>
                                    </tr>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-sm-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Best Project Manager</h3>
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Best Employee</h3>
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Vertical Type Projects</h3>


                            </div>
                            <div class="card-body">
                                <canvas id="horizontalChart1"
                                    style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Horizontal Type Projects</h3>


                            </div>
                            <div class="card-body">
                                <canvas id="horizontalChart2"
                                    style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                            </div>
