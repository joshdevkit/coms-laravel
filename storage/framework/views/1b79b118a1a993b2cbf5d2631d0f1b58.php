                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-sm-12 border-top">
                                <a href="<?php echo e(route('member.account-settings')); ?>" class="btn btn-primary btn-block">
                                    <i class="fas fa-cog mr-2"></i> Account Settings
                                </a>
                            </div>
                            <div class="col-sm-12 border-top">
                                <a href="<?php echo e(route('member.change-password')); ?>" class="btn btn-primary btn-block">
...
<?php /**PATH C:\xampp\htdocs\construction-management-system\resources\views/templates/member/topbar.blade.php ENDPATH**/ ?>