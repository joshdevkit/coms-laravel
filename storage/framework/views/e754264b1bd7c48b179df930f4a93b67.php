...
<head>
    ...
    <title>Manager | Update Password</title>
            ...
            <div class="col-md-6">
                <div class="card border-2">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('manager.update-password')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\construction-management-system\resources\views/manager/password/update-password.blade.php ENDPATH**/ ?>