        ...
        <div class="row justify-content-center align-items-center py-5">
            <div class="col-md-5">
                <div class="card">
                    ...
                    @endif
                        <form id="change_password" class="@if(!session('isOTP')) d-block @else d-none @endif" action="{{ route('owner.change-password') }}" method="POST">
                            @csrf
                        ...
                        <form id="otp_password" class="@if(session('isOTP')) d-block @else d-none @endif" action="{{ route('owner.change-password-otp') }}" method="POST">
                            @csrf
                            <div class="form-group mb-3">
